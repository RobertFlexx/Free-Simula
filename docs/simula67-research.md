...
The compiler test suite does not treat a keyword table as proof of conformance. Each area is classified as native-executable, syntax/semantic-only, intentionally extended, or unavailable in `docs/simula67-conformance.md`.
